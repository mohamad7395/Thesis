        ...
        if task == "ATE":
            ...
            if loader.test_df_id is not None:
                loader.test_df_id = loader.create_data_in_atsc_format(loader.test_df_id, 'aspectTerms', 'term', 'raw_text', 'aspect', instruct_handler.atsc['bos_instruct2'], 
                                                                    instruct_handler.atsc['delim_instruct'], instruct_handler.atsc['eos_instruct'])
            if loader.val_df_id is not None:
                loader.val_df_id = loader.create_data_in_atsc_format(loader.val_df_id, 'aspectTerms', 'term', 'raw_text', 'aspect', instruct_handler.atsc['bos_instruct2'], 
                                                                    instruct_handler.atsc['delim_instruct'], instruct_handler.atsc['eos_instruct'])
...
if __name__ == "__main__":
    epoch_addresses = [       
        '/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/14_l/ATE/agent.csv',
        '/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/14_l/ATE/prompting.csv',

        "/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/14_l/ATSC/agent.csv",
        "/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/14_l/ATSC/prompting.csv",

        '/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/14_l/ASPE/agent.csv',
        '/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/14_l/ASPE/prompting.csv',


        '/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/14_r/ATE/agent.csv',
        '/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/14_r/ATE/prompting.csv',

        "/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/14_r/ATSC/agent.csv",
        "/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/14_r/ATSC/prompting.csv",

        '/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/14_r/ASPE/agent.csv',
        '/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/14_r/ASPE/prompting.csv',
        
        '/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/15/ATE/agent.csv',
        '/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/15/ATE/prompting.csv', 

        "/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/15/ATSC/agent.csv",
        "/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/15/ATSC/prompting.csv",

        '/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/15/ASPE/agent.csv',
        '/home/s6moakba/InstructABSA/epoch_metrics/LRS_final/15/ASPE/prompting.csv',
    ]
