...
# epoch_adress = '/home/s6moakba/InstructABSA/epoch_metrics/14_l/ATSC/ATSC_baseline_14_l.csv'


# Load the data

id_train_file_path = '/home/s6moakba/InstructABSA/Dataset/SemEval14/Train/Laptops_Train.csv'

id_test_file_path = '/home/s6moakba/InstructABSA/Dataset/SemEval14/Test/Laptops_Test.csv'

id_tr_df = pd.read_csv(id_train_file_path)

# id_tr_df_gen = pd.read_csv(id_train_generated_file_path)

# id_tr_df_gen_sampled = id_tr_df_gen.sample(n=1200, random_state=41)
