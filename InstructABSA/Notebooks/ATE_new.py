...
model_out_path = './Models_baseline_ATE_16'



# Load the data

id_train_file_path = '/home/s6moakba/InstructABSA/Dataset/SemEval16/Train/Restaurants_Train.csv'

id_test_file_path = '/home/s6moakba/InstructABSA/Dataset/SemEval16/Test/Restaurants_Test.csv'
...
# with open('./Label_compare/baseline_validation.txt', 'w') as f:
