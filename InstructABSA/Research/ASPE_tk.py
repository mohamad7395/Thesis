...
from InstructABSA.extra_utils.preprocessing import format_aspe  

print("_________model_training_________")

model_checkpoint = "allenai/tk-instruct-base-def-pos"
model_out_path = "./Models_baseline_ASPE_16"
epoch_adress = "/home/s6moakba/InstructABSA/epoch_metrics/test.csv"
...
loader = format_aspe(loader, instruct_handler)

print("formatted train shape:", loader.train_df_id.shape)
